...
const MGKStrojobravarPage = () => {
    const ime_tvrtke = "MGK STROJOBRAVAR";
    ...
    <div className="main_content">
        ...
        <p>Cilj ovog projekta je održiva fizička, socijalna i gospodarska regeneracija grada Petrinje, s ciljem smanjenja socijalnih nejednakosti, isključenosti i siromaštva. 
            ...
            <div className="box">
                ...
                <p>Ukupna bespovratna sredstva EU (EUR): 178.971,56</p>
        ...
        <div className="container">
            <div className="activity_box">
                ...
                <p>Adresa: Trnjanska cesta 89, 10000 Zagreb</p>
                <p>Kontakt osoba: Stipan Skočibušić, direktor</p>
                <p>Mobitel: 098 906 8432</p>
        ...
        <div className="bottom-border" />
        <div className="container">
            <p>Prijavitelj, gospodarski subjekt MGK STROJOBRAVAR, OBRT ZA PROIZVODNJU I MONTAŽU, VL. STIPAN SKOČIBUŠIĆ, ZAGREB, 
                TRNJANSKA CESTA 89; OIB: 98859618479; sa sjedištem na adresi: Velika Gorica, Sv.Fabijana 54, naselje Kuče ovim 
