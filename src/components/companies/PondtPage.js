...
const PondtPage = () => {
  ...
  return (
    <div className="main_content">
        ...
        <div className="container">
            <p>Prijavitelj, gospodarski subjekt PONDT društvo s ograničenom odgovornošću za proizvodnju, trgovinu,
                uvoz-izvoz i usluge; OIB: 60078728358; sa sjedištem na adresi: Zagreb (Grad Zagreb), Barutanski
                ogranak IV. 5/1 ovim projektnim prijedlogom želi u provedbi projekta provesti niz aktivnosti, kojima bi
                nabavio nove robe i/ili usluge kako slijedi:</p>
