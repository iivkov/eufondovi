    ...
    <div className="main_content">
        ...
        <p>Cilj ovog projekta je održiva fizička, socijalna i gospodarska regeneracija grada Petrinje, s ciljem smanjenja socijalnih nejednakosti, isključenosti i siromaštva. 
            ...
            <div className="box">
                ...
                <p>Ukupna bespovratna sredstva EU (EUR): 177.959,84</p>
        ...
        <div className="container">
            <div className="activity_box">
                ...
                <p>KABEL-OPTIKA d.o.o.</p>
                <p>Adresa: Ulice Ćire Truhelke 15, 10000 Zagreb</p>
                <p>Kontakt osoba: Ivan Krešić, direktor</p>
                <p>Mobitel: 098 203 223</p>
