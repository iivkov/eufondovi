    ...
    <div className="main_content">
        ...
        <div className="container">
            <div className="activity_box">
                ...
                <p>STROJNA MEHANIKA d.o.o.</p>
                <p>Adresa: Palijaši 18, 10436 Zagreb, Horvati</p>
                {/* <p>Kontakt osoba: NN, direktor</p>
                <p>Mobitel: NNN NNN NNNN</p> */}
                <p>E-pošta: info@strojnamehanika.hr</p>
            </div>
        </div>
