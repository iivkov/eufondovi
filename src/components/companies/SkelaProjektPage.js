...
const SkelaProjektPage = () => {
    const ime_tvrtke = "SKELA PROJEKT d.o.o.";
    ...
    <div className="main_content">
        ...
        <img src={Petrinja} alt="Slika Petrinje." style={{ width: '100%', height: 'auto' }} />
            ...
            <div className="box">
                ...
                <p>Ukupna bespovratna sredstva EU (EUR): 173.462,98</p>
        ...
        <div className="container">
            <div className="activity_box">
                ...
                <p>SKELA PROJEKT d.o.o.</p>
                <p>Adresa: Ulica Kate Mlinarić 4, 10000 Zagreb</p>
                <p>Kontakt osoba: Blago Gudelj, direktor</p>
                <p>Mobitel: 099 535 1688</p>
